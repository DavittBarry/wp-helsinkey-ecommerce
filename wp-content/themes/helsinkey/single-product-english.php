    ...
    <div class="bg-gray-900 p-4 rounded-lg shadow-lg flex flex-col w-full max-w-3xl">
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <div class="mt-6 mb-6 text-center">
                <a href="<?php echo get_permalink(264); ?>" class="text-white bg-helsinkey-blue text-md p-4 py-2 rounded-xl transition-colors hover:bg-blue-600">Back to all products</a>
            </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var buttons = document.getElementsByClassName('single_add_to_cart_button button alt');
