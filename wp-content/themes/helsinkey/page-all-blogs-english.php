<?php
/*
Template Name: All Blogs English page
*/
...
<div class="blog-section py-6 md:py-12">
    <div class="container mx-auto">
        <h2 class="text-2xl md:text-3xl font-semibold mb-4 md:mb-6 text-center">All blog posts</h2>
                ...
                while ($all_blogs_query->have_posts()): 
                    ...
                    <div class="blog-item bg-gray-900 p-2 md:p-4 rounded shadow-lg flex flex-col">
                        ...
                        <div class="mt-auto mx-auto flex justify-center items-center">
                            <a href="<?php the_permalink(); ?>" class="text-white bg-helsinkey-blue text-xs md:text-sm mt-6 px-2 md:px-4 py-2 rounded-xl transition-colors hover:bg-blue-600">Read more</a>
                        </div>
                    </div>
                <?php endwhile; 
                wp_reset_postdata();
