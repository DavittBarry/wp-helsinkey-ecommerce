    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <div class="bg-gray-900 p-4 rounded-lg shadow-lg flex flex-col w-full max-w-3xl">
            ...
            <div class="text-sm text-gray-300 mb-4 text-center">
                Posted <?php the_author(); ?> <?php echo get_the_date(); ?>
            </div>
        ...
        <section class="mt-6 bg-gray-900 p-4 rounded-lg shadow-lg w-full max-w-3xl text-center">
            <div class="mb-4">
                <h2 class="text-xl font-bold text-white mb-2">Comments</h2>
            </div>
            <?php 
        ...
        <div class="mt-6 text-center">
            <a href="<?php echo get_permalink(322); ?>" class="text-white bg-helsinkey-blue text-md p-4 py-2 rounded-xl transition-colors hover:bg-blue-600">Back to all events</a>
        </div>
