<?php
/**
 * Template Name: New marketplace post english
 */
...
<script>
    function showSuccessPopup() {
        alert('Post was successfully sent!');
    }
</script>

<div class="container mx-auto mb-12 mt-12 p-4 bg-gray-900 text-white rounded-lg shadow-lg">
    <h2 class="text-2xl font-semibold mb-4 text-center">New Marketplace post</h2>
    <form method="post" enctype="multipart/form-data" class="space-y-4 mb-12 text-center">
        ...
        <div class="text-center">
            <label for="sijainti" class="block text-lg font-medium">Location</label>
            <input type="text" id="sijainti" name="sijainti" class="mt-1 p-2 w-1/2 bg-gray-700 text-white border border-gray-600 rounded-md">
        </div>
        <div class="text-center">
            <label for="yhteystiedot_nimi" class="block text-lg font-medium">Name</label>
        ...
        <div class="text-center">
            <label for="yhteystiedot_sahkoposti" class="block text-lg font-medium">E-mail</label>
        ...
        <div class="text-center">
            <label for="yhteystiedot_puhelinnumero" class="block text-lg font-medium">Phone number</label>
        ...
        <div class="text-center">
            <label for="hinta" class="block text-lg font-medium">Price (€)</label>
