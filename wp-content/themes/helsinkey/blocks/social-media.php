<!-- Social Media Feed -->
<div class="social-media-feed py-6 md:py-12">
    <div class="container mx-auto">
        ...
        mb-4
        md:mb-6
        text-center">Seuraa minua</h2>
        <div class="flex justify-center space-x-4">
            <!-- LinkedIn -->
            <a 
            href=
            "https://www.linkedin.com/in/davittbarry/" 
            target=
            "_blank" 
            class=
            "transform
