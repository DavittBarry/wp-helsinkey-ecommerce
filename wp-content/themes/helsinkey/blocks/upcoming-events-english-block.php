...
<div class="events-section py-6 md:py-12">
    <div class="container mx-auto">
        <h2 class="text-2xl md:text-3xl font-semibold mb-4 md:mb-6 text-center">Upcoming events</h2>
                ...
                while ($events_query->have_posts()): 
                    ...
                    <div class="event-item bg-gray-900 p-2 md:p-4 rounded shadow-lg flex flex-col justify-between <?php echo ($event_count > 3) ? 'hidden lg:hidden' : ''; ?> <?php echo ($event_count > 2) ? 'hidden md:hidden lg:block' : ''; ?>">
                        ...
                        <div class="mt-4 flex justify-center items-center">
                            <a href="<?php the_permalink(); ?>" class="text-white bg-helsinkey-blue text-xs md:text-sm px-2 md:px-4 py-2 rounded-xl transition-colors hover:bg-blue-600">Read all</a>
                        </div>
                    </div>
                <?php endwhile; 
                wp_reset_postdata();
        ...
        <?php if ($total_events > 2): ?>
            <div class="mt-12 text-center lg:hidden xl:hidden 2xl:hidden">
                <a href="<?php echo get_permalink(322); ?>" class="text-white bg-helsinkey-blue text-md md:text-md p-4 md:p-4 py-2 rounded-xl transition-colors hover:bg-blue-600">Show all events</a>
            </div>
        <?php endif; ?>
