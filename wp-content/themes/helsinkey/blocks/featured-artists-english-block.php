...
<div class="featured-artists py-6 md:py-12">
    <div class="container mx-auto">
        <h2 class="text-2xl md:text-3xl font-semibold mb-4 md:mb-6 text-center">Featured Artists</h2>
                ...
                while ($artists_query->have_posts()): 
                    ...
                    <div class="artist-item bg-gray-900 p-2 md:p-4 rounded shadow-lg <?php echo ($artist_count > 3) ? 'hidden lg:hidden' : ''; ?> <?php echo ($artist_count > 2) ? 'hidden md:hidden lg:block' : ''; ?>">
                        ...
                        <div class="mt-auto flex justify-center items-center">
                            <a href="<?php the_permalink(); ?>" class="text-white bg-helsinkey-blue text-xs md:text-sm ml-6 mt-6 px-2 md:px-4 py-2 rounded-xl transition-colors hover:bg-blue-600">Show profile</a>
                        </div>
                    </div>
                <?php endwhile; 
                wp_reset_postdata();
        ...
        <?php if ($total_artists > 2): ?>
            <div class="mt-12 text-center lg:hidden xl:hidden 2xl:hidden">
                <a href="<?php echo get_permalink(261); ?>" class="text-white bg-helsinkey-blue text-md md:text-md p-4 md:p-4 py-2 rounded-xl transition-colors hover:bg-blue-600">Show all artists</a>
            </div>
        <?php endif; ?>
